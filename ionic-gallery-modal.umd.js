    ...
    GalleryModalModule.decorators = [
        { type: _angular_core.NgModule, args: [{
                    imports: [
                        ...
                        ionicAngular.IonicModule.forRoot(TouchEventsDirective),
                        ionicAngular.IonicModule.forRoot(FittedImage),
                        ionicAngular.IonicModule.forRoot(ZoomableImage),
                        ionicAngular.IonicModule.forRoot(GalleryModal),
                    ],
                    declarations: [
                        FittedImage,
                        ZoomableImage,
